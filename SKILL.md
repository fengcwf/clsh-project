...
| v5.66.0 | 2026-06-12 | **SDD 优化落地**：PRODUCT.md + TECH.md + validation-report.md；新增 Pitfall #149-#155；gate-phase1.py 增加 PRODUCT.md 检查 |
| v5.65.0 | 2026-06-11 | **P0+P1+P2 修复**：合并重复 Pitfall、修复版本号冲突、统一绝对路径 |
...
| 分类 | 路径 |
|------|------|
| **教训** | `/mnt/unraid_data/Obsidian/raw/projects/clsh-project/references/pitfalls/common.md` — #51-#156 活跃 Pitfalls |
...
| 项目 | 路径/工具 |
|------|----------|
| **机械脚本** | `/root/.hermes/scripts/gate-phase1.py` / `gate-phase4.py` / `gate-phase5.py` / `gate-phase6.py` / `gate-phase8.py` / `phase4-mechanical-check.py` |
...
| **描述层评分** | `darwin-scorer.py <SKILL.md>` — 9 维度文档质量评分 |

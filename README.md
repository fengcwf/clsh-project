...
curl -sSL https://raw.githubusercontent.com/clsh/spec-driven-project/main/install.sh | bash

# Or clone manually
git clone https://github.com/clsh/spec-driven-project.git
cp -r spec-driven-project/SKILL.md ~/.your-assistant/skills/
cp -r spec-driven-project/templates ~/.your-assistant/skills/
```
